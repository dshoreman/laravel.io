...
@section('body')
    ...
    <section class="overflow-x-hidden mt-6 lg:mt-20">
        <div class="container mx-auto">
            <div class="flex flex-col items-center px-4 lg:flex-row xl:-mx-24 2xl:-mx-32">
    ...
    <!-- Help others -->
    <section class="mt-14 lg:mt-36 container mx-auto">
        <div class="px-4">
            ...
            <div class="flex mb-4 -mx-4 p-4 gap-4 lg:mb-10 overflow-x-scroll">
    ...
    <section class="mt-40 container mx-auto px-4">
        <h2 class="text-4xl leading-tight font-bold text-center text-gray-900 mb-6 lg:mb-12">Laravel.io in numbers</h2>

        <div class="flex flex-col lg:mb-10 lg:flex-row">
            <div class="w-full flex-shrink-0 lg:w-1/3">
    ...
    <!-- Popular articles -->
    <section class="my-40 container mx-auto px-4">
        ...
        <div class="flex flex-col lg:flex-row lg:mb-16">
            <div class="w-full lg:w-1/3 lg:mr-5">
                <x-articles.summary 
